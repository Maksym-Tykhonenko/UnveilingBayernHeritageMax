...
import UnveilingBayernHeritageProdScr from './src/screens/UnveilingBayernHeritageProdScr';
// libs
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://magical-notable-championship.space/`;
  const URL_IDENTIFAIRE = `u0lR21dC`;
  ...
  OneSignal.initialize('2907cb54-6f72-4c2f-81f2-43f018659727');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-07-11T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({isFatch}) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="UnveilingBayernHeritageProdScr"
            component={UnveilingBayernHeritageProdScr}
    ...
    return (
      <Stack.Navigator initialRouteName={'OnbOfTheUnveiling'}>
        <Stack.Screen
          name="OnbOfTheUnveiling"
          component={OnboardingOfTheUnveilingScreen}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="LoadUnveilingApp"
          component={UnvelingLoadingPage}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="UnveilingHomeScreen"
          component={UnveilingHomeScreen}
          options={{headerShown: false}}
        />
      </Stack.Navigator>
    );
  ...
  return (
    <NavigationContainer>
      {!louderPrevIsEnded ? <UnvelingLoadingPage /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};
